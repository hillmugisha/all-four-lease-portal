...
import { Eye, X, Search, ChevronLeft, ChevronRight, Download, Upload, Columns, Wrench, Loader2, AlertTriangle, ShoppingCart } from 'lucide-react'
                  ...
                  <tr key={lease.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    {visibleDefs.map((col) => (
                      <td
                        ...
                        title={getCellTitle(col.key, lease)}
                      >
