...
import { ColKey, COLUMNS, DEFAULT_WIDTHS, DEFAULT_COLS_EXPIRED, buildCell } from '@/lib/portfolio-columns'
...
export default function LeaseHistoryTable({ leases, loading }: TableProps) {
  ...
  const tableWidth  = 70 + visibleDefs.reduce((acc, col) => acc + (colWidths[col.key] ?? col.width), 0)
